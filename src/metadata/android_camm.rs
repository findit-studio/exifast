...
use crate::metadata::{GpsLocation, MediaMetadata, MetaProjectInto};
...
// ===========================================================================
// MetaProjectInto — Android CAMM projection into MediaMetadata
// ===========================================================================

impl MetaProjectInto for CammMeta {
  /// Project Android CAMM metadata into [`MediaMetadata`].
  ///
  /// **GpsLocation:** Android CAMM (camm5/camm6) is the **SECOND-HIGHEST
  /// tier** of the GPS priority chain (below GoPro GPMF, above Sony rtmd).
  /// The FIRST sample carrying a coordinate pair populates `GpsLocation`
  /// (`first_fix()`); only camm6 carries `GPSDateTime` per-sample (camm5's
  /// timestamp lives at the sample-table level and is left to the engine
  /// to surface).
  ///
